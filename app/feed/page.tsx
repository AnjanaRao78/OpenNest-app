  ...
  useEffect(() => {
    const unsub = subscribeToAuth(async (authUser) => {
      ...
      try {
        ...
        const data = (await loadReflectionsForHome(userProfile.familyId, authUser.uid, userProfile.relationship)) as ReflectionPost[];

        const filtered = data.filter((post: ReflectionPost) =>
